...
//   #[error("Comments must be separated from other tokens by white space characters")]
//   UnSupportedComments,

//   #[error("Unexpected character after closing quote")]
//   UnExpectedCharacterAfterDoubleQuote,

//   #[error("Unexpected character after closing quote")]
//   UnExpectedOpeningQuote,

//   #[error("Invalid Syntax: colon present multiple times on the single row")]
//   UnExpectedMultipleColonOnLine,

//   #[error("Invalid syntax: Unclosed quote")]
//   UnClosedQuotes
// }
